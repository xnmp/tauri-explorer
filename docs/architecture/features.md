...
| Feature | Files to change |
|---------|----------------|
| Miller columns | `MillerColumns.svelte` — optional 1-3 ancestor columns panel (left of file list, directories only), resizable, draggable to bookmarks, works with any view mode |
