...
- `src-tauri/src/files/permanent_delete.rs` — WIP observation/execution seam for permanent deletion (#739); substitution regressions are intentionally red, identity protection is not implemented.
