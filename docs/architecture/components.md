...
| **Sidebar** | `Sidebar.svelte` | Home button, dual-pane toggle, Quick Access (system folders + user bookmarks with drag-to-reorder), Recent locations (from frecency), This PC (drives). Resizable (180-400px) |
