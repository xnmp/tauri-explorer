...
- `window-keyboard.ts` — owns window input listeners, exact terminal command dispatch, native button activation, accepted custom-control input and modifier/chord release on blur or teardown.
