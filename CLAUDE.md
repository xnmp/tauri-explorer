...
- New dialogs/modals must style their own buttons (border-radius, theme colors, hover/focus states) rather than relying on bare browser defaults — a lone `padding` rule on a footer selector is not enough (#554).
