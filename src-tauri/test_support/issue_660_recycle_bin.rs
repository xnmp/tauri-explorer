...
fn issue_660_recycle_bin_uses_only_an_absolute_xdg_data_home() {
    ...
    assert_eq!(
        linux_trash_files_directory_from(Some(OsString::new()), Some(PathBuf::from("/home/alice"))).unwrap(),
        PathBuf::from("/home/alice/.local/share/Trash/files"),
    );
    assert_eq!(
        linux_trash_files_directory_from(Some(OsString::from("relative/data")), Some(PathBuf::from("/home/alice"))).unwrap(),
        PathBuf::from("/home/alice/.local/share/Trash/files"),
    );
}
